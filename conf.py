...
SITE_URL = "https://karllorey.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://karllorey.com/"
BLOG_EMAIL = "hello@karllorey.com"
BLOG_DESCRIPTION = "Personal website of Karl Lorey"  # (translatable)
...
# changed output of pages from "pages" to ""
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
    ("pages/*.txt", "", "page.tmpl"),
...
GITHUB_SOURCE_BRANCH = 'src'  # todo not sure about this one
...
# before deploying.
GITHUB_COMMIT_SOURCE = False  # using travis CI
...
GLOBAL_CONTEXT = {
    "now": datetime.now()  # needed for footer date
}
